    ...
    <div class="overlay" v-if="status">
      <div class="modal">
        <div class="modal__head">
          <img :src="require('~/assets/images/icons/status-mark-ok.svg')" alt="">
          <div class="text">{{ title }}</div>
          <button class="close" @click="closeModal"></button>
        </div>
        <div class="modal__body">
          <div class="text" v-html="content.title"></div>
...
<script>
  ...
  const { mapState, mapActions } = createNamespacedHelpers("dialogModal");

  export default {
    name: "DialogModal",
    computed: {
      ...mapState(["status", "title", "content"])
    },
    methods: {
