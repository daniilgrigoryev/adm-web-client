  ...
  export default {
    ...
    methods: {
      formatValues(valueFirst, valueSecond) {
        if (funcUtils.isNotEmpty(valueFirst) && funcUtils.isNotEmpty(valueSecond) && valueFirst.getTime() <= valueSecond.getTime()) {
          this.currentValue = funcUtils.parseDateTime(valueFirst, this.momentFormat) + ' - ' + funcUtils.parseDateTime(valueSecond, this.momentFormat);
        } else {
