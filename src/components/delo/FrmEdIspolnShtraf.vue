<template>
  <div v-if="body">
    <Form :label-width="180" label-position="right">
      ...
      <FormItem class="my12">
        <small class="adm-text-small color-gray-medium" slot="label">Дата исполнения по решению</small>
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
      ...
      <FormItem class="my12">
        <small class="adm-text-small color-gray-medium" slot="label">Сумма оплаты штрафа</small>
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
      ...
      <FormItem class="my12">
        <small class="adm-text-small color-gray-medium" slot="label">Универсальный идентификатор платежа</small>
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
      ...
      <FormItem class="my12">
        <small class="adm-text-small color-gray-medium" slot="label">Банк</small>
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
