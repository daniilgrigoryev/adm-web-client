<template>
  <div v-if="body" class="wmax940 mx-auto">
    <div class="adm-form">
      ...
      <h2 class="adm-text-big color-dark-light headding">Сведения об автомобиле</h2>
      ...
      <h2 class="adm-text-big color-dark-light headding">Документы автомобиля</h2>
      <div class="adm-form__item">
      ...
      <h2 class="adm-text-big color-dark-light headding">Проверки данных</h2>
      <div class="adm-form__item">
