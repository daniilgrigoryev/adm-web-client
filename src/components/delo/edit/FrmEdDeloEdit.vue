  ...
  <div v-if="delo">
    ...
    <div class="adm-form">
      ...
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Input class="adm-input adm-input--regular" :value="delo.dopSved" placeholder="Enter something..." type="textarea" :autosize="{minRows: 2,maxRows: 5}"></Input>
          </Col>
        </Row>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      parseDate(data) {
        if (funcUtils.isNotEmpty(data.deloDate)) {
          data.deloDate = new Date(data.deloDate);
        }
