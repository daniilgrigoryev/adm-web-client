  ...
  <div v-if="vuVyd">
    ...
    <div class="adm-form">
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Select class="adm-input adm-input--regular wmax240 wmin180" placeholder="" v-model="vuVyd.docTip" clearable filterable @on-change="store">
      ...
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Input class="adm-input adm-input--regular" v-model="vuVyd.inspVydKod" @on-input-change="changeInspVydKod" placeholder="Enter something..."></Input>
          </Col>
      ...
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Input class="adm-input adm-input--regular" v-model="vuVyd.inspVydName" @on-input-change="changeFIO" placeholder="Enter something..."></Input>
          </Col>
        </Row>
      </div>
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Input class="adm-input adm-input--regular" v-model="vuVyd.inspVydDolz" @on-input-change="clearInspVydKod" placeholder="Enter something..."></Input>
          </Col>
        </Row>
      </div>
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Input class="adm-input adm-input--regular" v-model="vuVyd.inspVydRang" @on-input-change="clearInspVydKod" placeholder="Enter something..."></Input>
          </Col>
        </Row>
      </div>
      ...
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Input class="adm-input adm-input--regular" v-model="vuVyd.ogaiVydKod" @on-input-change="changeOgaiVydKod" placeholder="Enter something..."></Input>
          </Col>
          <Col :xs="24" :md="14" :lg="8">
