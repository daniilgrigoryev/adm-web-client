<template>
  <div v-if="uchastOrganization" class="wmax940 mx-auto">
    ...
    <div class="amd-title amd-title--sticky px36 py24 bg-white-light">
      <div class="flex-parent flex-parent--space-between-main flex-parent--center-cross">
        ...
        <Button type="text" style="outline: 0!important;" class="px0 py0 cursor-pointer bg-transparent-on-hover">
    ...
    <div class="flex-parent flex-parent--center-cross flex-parent--end-main px36 adm-btn-footer--sticky bg-white-light py12">
