<template>
  <aside-template :listSectionNav="listSectionNav" title="Ходатайство по делу" v-if="docsPetition">
            ...
            <div class="adm-form__content">
              ...
              <div class="adm-form__item">
                ...
                <div class="adm-form__item_content">
                  <Row :gutter="16" type="flex" align="middle">
                    <Col :xs="24" :md="14" :lg="16">
                      <DatePickerMask class="adm-input adm-input--regular wmin120 wmax180" v-model="docsPetition.dateSost" @change="store" clearable type="datetime" placeholder="дд/мм/гггг чч:мм" momentFormat="DD/MM/YYYY HH:mm" maskFormat="dd/mm/yyyy HH:MM"></DatePickerMask>
                    </Col>
                  </Row>
                </div>
              </div>
            ...
            <div class="adm-form__content">
              <div class="adm-form__item">
                ...
                <div class="adm-form__item_content">
                  <Row :gutter="16" type="flex" align="middle">
                    <Col :xs="4" :md="4" :lg="4">
                      <masked-input inputClass="adm-input adm-input--regular" v-model="docsPetition.inspSostKod" :maskProps="{casing: 'upper', regex: '[0-9]+', placeholder: ''}" @onInputChange="changeInspSostKod" ></masked-input>
                    </Col>
                    <Col :xs="18" :md="18" :lg="18">
                      <Input class="adm-input adm-input--regular" readonly :value="docsPetition.inspSostName, docsPetition.inspSostDolz, docsPetition.inspSostRang | concatByDelimiter(',')"></Input>
                    </Col>
                    <Col :xs="2" :md="2" :lg="2">
              ...
              <div class="adm-form__item">
                ...
                <div class="adm-form__item_content">
                  <Row :gutter="16" type="flex" align="middle">
                    <Col :xs="4" :md="4" :lg="4">
                      <masked-input inputClass="adm-input adm-input--regular" v-model="docsPetition.organSostKod" :maskProps="{casing: 'upper', regex: '[0-9]+', placeholder: ''}" @onInputChange="changeOrganSostKod" ></masked-input>
                    </Col>
                    <Col :xs="18" :md="18" :lg="18">
                      <Input class="adm-input adm-input--regular" readonly :value="docsPetition.organSostName" ></Input>
                    </Col>
                    <Col :xs="2" :md="2" :lg="2">
                ...
                <div class="adm-form__item_content">
                  <Row :gutter="16" type="flex" align="middle">
                    <Col :xs="22" :md="22" :lg="22">
                      <Input class="adm-input adm-input--regular" disabled v-model="docsPetition.placeSost.placeFull"></Input>
                    </Col>
                    <Col :xs="2" :md="2" :lg="2">
            ...
            <div class="adm-form__content">
              <div class="adm-form__item">
                ...
                <div class="adm-form__item_content">
                  <Row :gutter="16" type="flex" align="middle">
                    <Col :xs="24" :md="14" :lg="16">
                      <Input inputClass="adm-input adm-input--regular wmin120" v-model="docsPetition.reason" @onInputChange="store"></Input>
                    </Col>
                  </Row>
                </div>
              </div>
              ...
              <div class="adm-form__item">
                ...
                <div class="adm-form__item_content">
                  <Row :gutter="16" type="flex" align="middle">
                    <Col :xs="4" :md="4" :lg="4">
                      <masked-input inputClass="adm-input adm-input--regular" v-model="docsPetition.inspUtvKod" :maskProps="{casing: 'upper', regex: '[0-9]+', placeholder: ''}" @onInputChange="changeInspUtvKod" ></masked-input>
                    </Col>
                    <Col :xs="18" :md="18" :lg="18">
                      <Input class="adm-input adm-input--regular" disabled v-model="docsPetition.inspUtvName"></Input>
                    </Col>
                    <Col :xs="2" :md="2" :lg="2">
  ...
  export default {
    ...
    async created() {
      try {
        ...
        let docsPetition = JSON.parse(eventResponse.response).data;

        if (funcUtils.isEmpty(docsPetition)) {
          let error = JSON.parse(eventResponse.response).error;
          this.$store.dispatch('errors/changeContent', {title: error.errorMsg, desc: error.errorDesc,});
        } else {
          this.docsPetition = docsPetition;
        }
      } catch (e) {
    ...
    methods: {
      ...
      async changeInspSostKod() {
        if (funcUtils.isNotEmpty(this.docsPetition.inspSostKod)) {
          let eventResponse = await RequestApi.prepareData({
            method: 'getSinspList',
            params: {
          ...
          if (funcUtils.isNotEmpty(data) && data.length > 0) {
            data = data.getFirst();
            this.docsPetition.inspSostId = data.inspId;
            this.docsPetition.inspSostKod = data.inspKod;
            this.docsPetition.inspSostName = data.inspName;
            this.docsPetition.inspSostDolz = data.inspDolz;
            this.docsPetition.inspSostRang = data.inspRang;
            this.docsPetition.organSostId = data.ogaiId;
            this.docsPetition.organSostKod = data.organKod;
            this.docsPetition.organSostName = data.ogaiName;
            this.store();
          }
        } else {
          this.clearInspSost();
      ...
      async changeOrganSostKod() {
        if (funcUtils.isNotEmpty(this.docsPetition.organSostKod)) {
          let eventResponse = await RequestApi.prepareData({
            method: 'getGibddDict',
            params: {
      ...
      async changeInspUtvKod() {
        if (funcUtils.isNotEmpty(this.docsPetition.inspUtvKod)) {
          let eventResponse = await RequestApi.prepareData({
            method: 'getSinspList',
            params: {
              inspKod: this.docsPetition.inspUtvKod
            }
          });
          ...
          if (funcUtils.isNotEmpty(data) && data.length > 0) {
            data = data.getFirst();
            this.docsPetition.inspUtvId = data.inspId;
            this.docsPetition.inspUtvKod = data.inspKod;
            this.docsPetition.inspUtvName = data.inspName;
            this.docsPetition.inspUtvDolz = data.inspDolz;
            this.docsPetition.inspUtvRang = data.inspRang;
            await this.store();
          }
        } else {
          this.clearInspUtv();
      ...
      onGibddClick(data) {
        this.docsPetition.organSostId = data.ID;
        this.docsPetition.organSostKod = data.ORGAN_KOD;
        this.docsPetition.organSostName = data.ORGAN_NAME;
        this.organModal.gibddList = null;
