            ...
            <Col :xs="24" :md="20" :lg="21">
              ...
              <Row type="flex" justify="start" :gutter="20">
                <Col :xs="24" :md="24" :lg="8">
                  <div class="flex-parent flex-parent--end-cross h-full">
                    <div class="w-full adm-form__item">
                      <div class="adm-12 color-dark-lighter search-label">Период</div>
                ...
                <Col :xs="12" :md="12" :lg="8">
                  <div class="flex-parent flex-parent--end-cross h-full">
                    <div class="w-full adm-form__item">
                      <div class="adm-12 color-dark-lighter search-label">Тип реестра</div>
                ...
                <Col :xs="12" :md="12" :lg="8">
                  <div class="flex-parent flex-parent--end-cross h-full">
                    <div class="w-full adm-form__item">
                      <div class="adm-12 color-dark-lighter search-label">Статус</div>
