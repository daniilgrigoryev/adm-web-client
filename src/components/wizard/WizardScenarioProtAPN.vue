...
<script>
  ...
  import WizardItemProtApnOne from "./items/protApn/WizardItemProtApnOne.vue";
  import WizardItemProtApnTwo from "./items/protApn/WizardItemProtApnTwo.vue";
  import WizardItemProtApnThree from "./items/protApn/WizardItemProtApnThree.vue";
  import WizardItemProtApnFour from "./items/protApn/WizardItemProtApnFour.vue";
  ...
  export default {
    ...
    components: {
      AsideTemplate,
      WizardItemProtApnOne,
      WizardItemProtApnTwo,
      WizardItemProtApnThree,
      WizardItemProtApnFour,
