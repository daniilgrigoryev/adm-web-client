      ...
      <Col :xs="24" :sm="18" :md="18" :lg="18">
        <div>
          <Layout ref="Main" class=" px36 py12" style="min-height: calc(100vh - 125px);">
            ...
            <wizard-item-place v-if="isVisible('DocProtEvacThree.PlaceSost')" ref="DocProtEvacThree.PlaceSost" :info="getInfo('DocProtEvacThree.PlaceSost')" title="Место нарушения" @storeElementData="storeElementData" @updateComponents="updateComponents"></wizard-item-place>
            ...
            <wizard-item-prot-evac-five id="DocProtEvacFive" v-if="isVisible('DocProtEvacFive')" ref="DocProtEvacFive" :info="getInfo('DocProtEvacFour')" @storeElementData="storeElementData" @updateComponents="updateComponents"></wizard-item-prot-evac-five>
