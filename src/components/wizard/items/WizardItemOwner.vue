  ...
  <div v-if="data">
    <div class="adm-form__item">
      ...
      <Row :gutter="16" type="flex" align="middle">
          ...
          <CustomSelect class="adm-input adm-input--regular wmax240 wmin180" placeholder="" v-model="data.status" clearable @on-change="storeElementData" @on-enter="storeElementData">
