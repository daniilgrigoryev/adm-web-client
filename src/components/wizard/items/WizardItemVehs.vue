        ...
        <div class="adm-form__content px36 py24">
          ...
          <div class="adm-form__item">
            ...
            <div class="adm-form__item_content">
              <Row :gutter="16" type="flex" align="middle">
                <Col :xs="24" :md="14" :lg="16">
                  <!-- TODO -->
                  <masked-input inputClass="adm-input adm-input--regular wmax240" :maskProps="{casing: 'upper', regex: '[a-zA-Zа-яА-Я0-9]+', placeholder: ''}" @onInputChange="storeElementData" ></masked-input>
                </Col>
              </Row>
            </div>
          </div>
          <div class="adm-form__item">
            ...
            <div class="adm-form__item_content">
              <Row :gutter="16" type="flex" align="middle">
                <Col :xs="24" :md="14" :lg="16">
                  <masked-input inputClass="adm-input adm-input--regular wmax240" v-model="data.vin" :maskProps="{regex: '[a-zA-Zа-яА-Я0-9]+', placeholder: '', casing: 'upper'}"  @onInputChange="storeElementData"></masked-input>
                </Col>
              </Row>
            </div>
          </div>
          <div class="adm-form__item">
            ...
            <div class="adm-form__item_content">
              <Row :gutter="16" type="flex" align="middle">
                <Col :xs="24" :md="14" :lg="16">
                  <masked-input inputClass="adm-input adm-input--regular wmax240" v-model="data.color" :maskProps="{regex: '[a-zA-Zа-яА-Я0-9]+', placeholder: '', casing: 'upper'}"  @onInputChange="storeElementData"></masked-input>
                </Col>
              </Row>
            </div>
          </div>
