        ...
        <div class="adm-form__content px36 py24">
          ...
          <div class="adm-form__item">
            ...
            <div class="adm-form__item_content">
              <Row :gutter="16" type="flex" align="middle">
                <Col :xs="24" :md="14" :lg="16">
                  <!-- TODO -->
                  <masked-input inputClass="adm-input adm-input--regular wmax240" @onInputChange="storeElementData"
                                :maskProps="{casing: 'upper', regex: '[a-zA-Zа-яА-Я0-9/]+', placeholder: ''}"></masked-input>
                </Col>
              </Row>
            </div>
          </div>
          ...
          <div class="adm-form__item">
            ...
            <div class="adm-form__item_content">
              <Row :gutter="16" type="flex" align="middle">
                <Col :xs="24" :md="14" :lg="16">
                  <Select class="adm-input adm-input--regular wmax240 wmin180" placeholder="" v-model="data.ownerTip"
                          :disabled="isEmptyParentNode()" clearable @on-change="storeElementData" filterable>
                    <Option v-for="item in ownerList" :value="item.value" :key="item.value">{{ item.label }}
                    </Option>
                  </Select>
                </Col>
              </Row>
