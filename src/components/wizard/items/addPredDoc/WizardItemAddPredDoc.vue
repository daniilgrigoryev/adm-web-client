<template>
  <div v-if="data">
    <div class="adm-form__item">
      ...
      <Row :gutter="16" type="flex" align="middle">
        <Col :xs="24" :md="14" :lg="16">
           <masked-input inputClass="adm-input adm-input--regular wmax360 wmin180" v-model="data.docNum" :maskProps="{casing: 'upper', regex: '[a-zA-Zа-яА-Я0-9]+', placeholder: ''}" clearable @onInputChange="storeElementData"></masked-input>
        </Col>
      </Row>
    </div>
    <div class="adm-form__item">
      ...
      <Row :gutter="16" type="flex" align="middle">
        <Col :xs="24" :md="14" :lg="16">
          <Select class="wmax360 wmin180 adm-input adm-input--regular" placeholder="" v-model="data.docTip" filterable clearable @on-change="storeElementData">
    ...
    <div class="adm-form__item">
      ...
      <Row :gutter="16" type="flex" align="middle">
        <Col :xs="24" :md="14" :lg="22">
          <masked-input inputClass="adm-input adm-input--regular wmax360 wmin180" v-model="data.vuOgaiVydName" :maskProps="{casing: 'upper', placeholder: ''}" clearable @onInputChange="storeElementData"></masked-input>
        </Col>
      </Row>
    </div>
  </div>
...
<script>
  ...
  export default {
    name: "WizardItemAddPredDoc",
    extends: WizardItemPredDoc
  }
</script>
