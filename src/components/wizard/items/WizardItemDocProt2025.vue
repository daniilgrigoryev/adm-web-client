  ...
  <div v-if="data">
    ...
    <div class="adm-form">
      ...
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Input class="adm-input adm-input--regular" v-model="data.organSostKod" disabled placeholder=""""></Input>
          </Col>
        </Row>
      </div>
      <div class="my12 adm-form__item">
      ...
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Input class="adm-input adm-input--regular" v-model="stotv" disabled placeholder=""""></Input>
          </Col>
        </Row>
      </div>
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Input class="adm-input adm-input--regular" v-model="data.organRasmName" disabled placeholder=""""></Input>
          </Col>
          <Col :xs="24" :md="14" :lg="8">
      ...
      <div class="my12 adm-form__item">
        ...
        <Row :gutter="16" type="flex" align="middle">
          <Col :xs="24" :md="14" :lg="16">
            <Input class="adm-input adm-input--regular" v-model="mainDelo" disabled placeholder=""""></Input>
          </Col>
          <Col :xs="24" :md="14" :lg="8">
