      ...
      <div class="adm-form__content">
          ...
          <div class="adm-form__item_content">
            <Row :gutter="16" type="flex" align="middle">
              <Col :xs="22" :md="22" :lg="22">
                <masked-input inputClass="adm-input adm-input--regular wmax240"  v-model="data.violatorClarification"  @onInputChange="storeElementData" placeholder="ГРЗ" :maskProps="{regex: '[a-zA-Zа-яА-Я0-9,.]+', casing: 'upper', placeholder: ''}"  clearable></masked-input>
              </Col>
            </Row>
          </div>
        </div>
        <div class="adm-form__item">
          ...
          <div class="adm-form__item_content">
            <Row :gutter="16" type="flex" align="middle">
              <Col :xs="22" :md="22" :lg="22">
                <masked-input inputClass="adm-input adm-input--regular wmax240"  v-model="data.officialClarification"  @onInputChange="storeElementData" placeholder="ГРЗ" :maskProps="{regex: '[a-zA-Zа-яА-Я0-9,.]+', casing: 'upper', placeholder: ''}"  clearable></masked-input>
              </Col>
            </Row>
          </div>
        </div>
...
export default {
	name: "WizardItemDocPostFirstStopDelo",
