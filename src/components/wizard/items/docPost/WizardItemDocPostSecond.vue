<template>
  <div v-if="data">
    ...
    <div class="adm-form__item">
      ...
      <Row :gutter="16" type="flex" align="middle">
        <Col :xs="24" :md="14" :lg="16">
          <CustomSelect class="adm-input adm-input--regular wmax240 wmin180" placeholder="" v-model="data.guiltAdmissionType" clearable filterable @on-change="storeElementData">
