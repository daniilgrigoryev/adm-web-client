      ...
      <div class="adm-form__content">
        <div class="adm-form__item">
          ...
          <Row type="flex" align="middle">
            <Col span="12">
              <CustomSelect class="adm-input adm-input--regular wmax360 wmin180" ref="city" placeholder="" v-model="data.status" filterable clearable @on-change="storeElementData" @on-enter="storeElementData">
