      ...
      <div class="adm-form__container mt6">
        ...
        <div class="adm-form__item">
          ...
          <Row :gutter="16" type="flex" align="middle">
            <Col>
              <CustomSelect class="wmax240 wmin180 adm-input adm-input--regular" placeholder="" v-model="data.status" clearable @on-change="changeStatus" @on-enter="changeStatus">
        ...
        <div class="adm-form__item">
          ...
          <Row :gutter="16" type="flex" align="middle">
            <Col :xs="24" :md="14" :lg="16">
              <CustomSelect class="adm-input adm-input--regular wmin180" v-model="data.gragdKod" filterable clearable @on-change="storeElementData" @on-enter="storeElementData" placeholder="">
        ...
        <div class="adm-form__item">
          ...
          <Row :gutter="16" type="flex" align="middle">
            <Col :xs="24" :md="14" :lg="16">
              <CustomSelect class="adm-input adm-input--regular wmax240 wmin180" placeholder="" v-model="data.birthMestoKod" filterable clearable @on-change="storeElementData" @on-enter="storeElementData">
        ...
        <div class="adm-form__item">
          ...
          <Row :gutter="16" type="flex" align="middle">
            <Col :xs="24" :md="14" :lg="16">
              <CustomSelect class="adm-input adm-input--regular wmin180" v-model="data.presentType" :disabled="!data.status" filterable clearable @on-change="storeElementData" @on-enter="storeElementData" placeholder="">
