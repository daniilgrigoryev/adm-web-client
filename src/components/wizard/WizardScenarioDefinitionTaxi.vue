      ...
      <Layout ref="Main" class="layout">
        <div class="adm-form">
          ...
          <wizard-item-definition-taxi-four-part2 id="DocDefinitionTaxiFourPart2" v-if="isVisible('DocDefinitionTaxiFour')" ref="DocDefinitionTaxiFour" :info="getInfo('DocDefinitionTaxiFour')" @storeElementData="storeElementData" @updateComponents="updateComponents">
            ...
            <wizard-item-address v-if="isVisible('DocDefinitionTaxiFour.Organization.regAddr')" ref="DocDefinitionTaxiFour.Organization.regAddr" :info="getInfo('DocDefinitionTaxiFour.Organization.regAddr')" title="Юридический адрес" @storeElementData="storeElementData" @updateComponents="updateComponents"></wizard-item-address>
