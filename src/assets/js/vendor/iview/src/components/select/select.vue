                    ...
                    if (cOptions.tag.match(optionGroupRegexp)){
                        ...
                        if (this.filterable){
                            children = children.filter(
                                ({componentOptions}) => this.validateOption(componentOptions, this.query)
                            );
                        }
                        ...
                        if (this.filterQueryChange) {
                            const optionPassesFilter = this.filterable ? this.validateOption(cOptions, this.query) : option;
